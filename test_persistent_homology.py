...
#             filename, extent = self.filename.split(".")
            ...
            print(cf.on_yellow(f"Loading diagrams from PH_{self.filename}..."))
            f = open(os.path.join(self.data_dir, "WD_" + self.filename), "rb")
            wdist_list = pickle.load(f)
            print(cf.on_yellow(f"Loading reference Wasserstein from WD_{self.filename}..."))
            f = open(os.path.join(self.data_dir, "WP_" + self.filename), "rb")
            wdist_pair_list = pickle.load(f)            
            print(cf.on_yellow(f"Loading pairwise Wasserstein from WP_{self.filename}..."))
        else:
            ...
            f = open(os.path.join(self.data_dir, "PH_" + self.filename), "wb")
            pickle.dump(Rs_list, f)   
            print(cf.on_yellow(f"Saving diagrams from PH_{self.filename}..."))
            f = open(os.path.join(self.data_dir, "WD_" + self.filename), "wb")
            pickle.dump(wdist_list, f) 
            print(cf.on_yellow(f"Saving reference Wasserstein from WD_{self.filename}..."))
            f = open(os.path.join(self.data_dir, "WP_" + self.filename), "wb")
            pickle.dump(wdist_pair_list, f) 
            print(cf.on_yellow(f"Saving pairwise Wasserstein from WP_{self.filename}..."))
